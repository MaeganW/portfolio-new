...
class Projects extends Component {
  render() {
    return (
      <div>
        <div class="float-left" id="projects-left">
          ...
          <div class="projects-container">
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-6 padding-left project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> Bootstrap3, CSS3, HTML5</p>
                <a type="button" href="https://github.com/MaeganW/Photo-App-Website" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
                <a type="button" href="https://maeganw.github.io/Photo-App-Website/PROJECT%20Gamma%20Photo%20App/index.html" class="btn btn-primary sharp see" target="_blank"><i class="fa fa-eye fa-lg" aria-hidden="true"></i> See the Site</a>
              </div>
            </div>
            <div class="row">
              <h1 class="project-title">Color Game App</h1>
              <div class="col-md-12 col-lg-6 padding-bottom project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> JavaScript, CSS3, HTML5</p>
                <a type="button" href="https://github.com/MaeganW/JS-Color-Game-App" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-6 padding-left project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> JavaScript, CSS3, HTML5</p>
                <a type="button" href="https://github.com/MaeganW/Pomodoro-Timer" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
                <a type="button" href="https://maeganw.github.io/Pomodoro-Timer/" class="btn btn-primary sharp see" target="_blank"><i class="fa fa-eye fa-lg" aria-hidden="true"></i> See the App</a>
              </div>
            </div>
            <div class="row">
              <h1 class="project-title">MetaVidz Search Engine</h1>
              <div class="col-md-12 col-lg-6 padding-bottom project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> JavaScript, JQuery, CSS3, HTML5, Youtube V3 Data API, Fancybox</p>
                <a type="button" href="https://github.com/MaeganW/Meta-Vidz-Search-Engine" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-6 padding-left project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> JavaScript, CSS3, HTML5</p>
                <a type="button" href="https://github.com/MaeganW/jQuery-Content-Slider" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
                <a type="button" href="https://maeganw.github.io/jQuery-Content-Slider/" class="btn btn-primary sharp see" target="_blank"><i class="fa fa-eye fa-lg" aria-hidden="true"></i> See the App</a>
              </div>
            </div>
            <div class="row">
              <h1 class="project-title">To-Do List App</h1>
              <div class="col-md-12 col-lg-6 padding-bottom project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> JavaScript, JQuery, CSS3, HTML5</p>
                <a type="button" href="https://github.com/MaeganW/JS-To-Do-List-App" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-6 padding-left project-unit">
                ...
                <p class="skills-text"><strong>Showcase Skills:</strong> JavaScript, Paper.js, Howler.js, CSS3, HTML5</p>
                <a type="button" href="https://github.com/MaeganW/Patatap-Clone" class="btn btn-primary sharp" target="_blank"><i class="fa fa-github fa-lg" aria-hidden="true"></i> View My Code</a>
                <a type="button" href="https://maeganw.github.io/Patatap-Clone/index.html" class="btn btn-primary sharp see" target="_blank"><i class="fa fa-eye fa-lg" aria-hidden="true"></i> See the App</a>
              </div>
            </div>
        ...
        <div class="float-right" id="projects-right">
